...
% Alternative fonts: \usepackage{libertine}, \usepackage{lmodern}, or comment out for Computer Modern
...
% Note: Placed after loading constants.tex so \name is defined
\hypersetup{
  pdftitle={Resume - \name},
  pdfauthor={\name},
  pdfsubject={Professional Resume},
  pdfkeywords={Software Engineer, Cloud Platform, DevOps, AI, GitHub Enterprise},
